                        ...
                        <div class="app-card-body">
                            <form class="settings-form" method="POST" action="{{route('employer.store')}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="setting-input-1" name="nom"  placeholder="Entrer le nom" value="{{old('nom')}}"required>
                                </div>
                                <div class="mb-3">
                                    <label for="setting-input-2" class="form-label">Prenom</label>
                                    <input type="text" class="form-control" id="setting-input-2" name="prenom" placeholder="Entrer le prenom" value="{{old('prenom')}}" required>
                                </div>
                                <div class="mb-3">
                                    <label for="setting-input-3" class="form-label">Email</label>
                                    <input type="email" class="form-control" id="setting-input-3" name="email" placeholder="Entrer le Email" value="{{old('email')}}">
                                    @error('email')
                                        <div class="text-danger"> {{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="setting-input-4" name="contact" placeholder="Entrer le contact" value="{{old('contact')}}">
                                    @error('phone
                                    ')
                                        <div class="text-danger"> {{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="setting-input-4" name="montant_journalier" placeholder="montant journalier" value="{{old('montant_journalier')}}">
                                </div>
