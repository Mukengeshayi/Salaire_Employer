                    ...
                    <div class="app-card app-card-settings shadow-sm p-4">
                        ...
                        <div class="app-card-body">
                            <form class="settings-form" method="POST" action="{{route('configuration.store')}}">
                                ...
                                @method('POST')
                                <div class="mb-3">
                                    <label for="setting-input-1" class="form-label">Type<span class="ms-2"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="setting-input-1" name="value" placeholder="Entrer la valeur " value="{{ old('value') }}" required>
                                    @error('value')
                                        <div class="text-danger"> {{$message}}</div>
                                    @enderror
                                </div>
