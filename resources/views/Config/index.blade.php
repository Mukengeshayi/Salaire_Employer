                                            ...
                                            <tr>
                                                <td class="cell"><span class="truncate"></span>
                                                   ...
                                                   @if ($config->type==="DEVELOPPER_NAME")
                                                       Nom d'equipe du developpement
                                                   @endif
                                                </td>
                                                <td class="cell"><span class="truncate"></span>{{$config->value}}
                                                   @if ($config->type==="PAYMENT_DATE")
                                                       de chaque mois
                                                   @endif
                                                </td>
                                                <td class="cell"><span class="truncate"></span>
                                                    <a class="btn-sn btn app-btn-secondary" href="{{route('configuration.delete',$config->id)}}">Retirer</a>
                                                </td>
                                            </tr>

                                        @empty
                                            <tr>
                                                <td class="cell" colspan="4">Aucune configuration enregistréé</td>
                                            </tr>
                                        @endforelse
