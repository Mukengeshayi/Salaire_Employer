        ...
        <div class="container-xl">
            ...
            <div class="row g-4 settings-section">
                <div class="col-12 col-md-4">
                    ...
                    <div class="section-intro">Mettre à jour un departement</div>
                </div>
                        ...
                        <div class="app-card-body">
                            <form class="settings-form" method="POST" action="{{route('departement.update', $departement->id)}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="setting-input-1" name="name" value="{{$departement->name}} " placeholder="Entrer le nom du departement"required>
                                    @error('name')
